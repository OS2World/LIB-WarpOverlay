...
*/
  ...
  */
  ...
  ULONG _Optlink VHMap(PVOID, ULONG);
  ULONG _Optlink VHMapVRAM(ULONG, ULONG, PBYTE *, PBYTE *);
  ULONG _Optlink VHLockMem(PVOID, ULONG, BOOL);
  ULONG _Optlink VHUnLockMem(ULONG);
  PVOID _Optlink VHAllocMem(ULONG);
  ULONG _Optlink VHFreeMem(PVOID);
  ULONG _Optlink VHPhysToVirt(PMEMINFO);
  ULONG _Optlink VHGetVRAMInfo(PMEMINFO);
  ULONG _Optlink VHSetMTRR(PMTRRIN, BOOL);
